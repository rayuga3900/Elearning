...
import com.example.elearning.databinding.StudentActivityRequestBinding;
...
public class studentrequest extends AppCompatActivity {
    ...
    private StudentActivityRequestBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_activity_request);
        binding = StudentActivityRequestBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        Intent intent=getIntent();
        uname=intent.getStringExtra("username");
        usertype=intent.getStringExtra("usertype");
        sm=new SessionManager(getApplicationContext());
        tverror = findViewById(R.id.studreqtverror);
        ...
        bottomNavigationView.setSelectedItemId(R.id.menu_student);
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            @Override
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.menu_teacher) {
                    startActivity(new Intent(studentrequest.this, teacherrequest.class)
                            .putExtra("username",uname)
                            .putExtra("usertype",usertype)
                            .addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION));
                    return true;
                } else if (item.getItemId() == R.id.menu_admin) {
                    startActivity(new Intent(studentrequest.this, Admin.class)
                            .putExtra("username",uname)
                            .putExtra("usertype",usertype)
                            .addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION));;
                    return true;
    ...
    private void fetchData() {
        ...
        Call<List<requestmodel>> call = sql.getrequest("Student");
            ...
            public void onResponse(Call<List<requestmodel>> call, Response<List<requestmodel>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    for (requestmodel model : requestModels) {
                        ...
                        requestarr.add(new requestmodel(name, username,"Student"));
                    }
    ...
    private void updateRecyclerView() {
        // Update the RecyclerView adapter with new data
        useradapter adapter = new useradapter(studentrequest.this, requestarr);
